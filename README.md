...
* **`MLPimplicit3D.py`**: Trains a Multi-Layer Perceptron (MLP) in PyTorch to implicitly learn the 3D shape occupancy directly from coordinate data.
* **`show_mesh.py / show_mesh_trimesh.py`**: A helper script to open and interactively view the generated 3D meshes.
